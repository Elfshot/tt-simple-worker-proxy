/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 91209a5f6fafd5f7bfe972a4042b0ac7)
// Runtime types generated with workerd@1.20250428.0 2025-04-30 
declare namespace Cloudflare {
	interface Env {
		DEFAULT_TYCOON_PRIVATE: string;
		DEFAULT_TYCOON_PUBLIC: string;
		ASSETS: Fetcher;
	}
}
